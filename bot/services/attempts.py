...
start_attempt = sync_to_async(attempt_services.start_attempt, thread_sensitive=True)
get_draft_attempt = sync_to_async(attempt_services.get_draft_attempt, thread_sensitive=True)
cancel_attempt = sync_to_async(attempt_services.cancel_attempt, thread_sensitive=True)
save_answer = sync_to_async(attempt_services.save_answer, thread_sensitive=True)
toggle_multi_choice = sync_to_async(attempt_services.toggle_multi_choice, thread_sensitive=True)
set_current_order = sync_to_async(attempt_services.set_current_order, thread_sensitive=True)
...
submit_attempt = sync_to_async(attempt_services.submit_attempt, thread_sensitive=True)
